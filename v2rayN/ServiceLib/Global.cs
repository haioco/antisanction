...
public class Global
{
    ...
    public const string AppName = "HAIO Anti-Sanction";
    ...
    public const string AutoRunName = "haio-antisanctionAutoRun";
    ...
    public const string AvaAssets = "avares://haio-antisanction/Assets/";
    public const string LocalAppData = "HAIO_ANTISANCTION_LOCAL_APPLICATION_DATA";
